...
- Adds five strategic command windows across the late campaign (rounds 42/56/68/84/98), deliberately avoiding boss rounds and v10.0 command-operation start rounds.
