...
<p align="center">
  ...
  <img alt="Roadmap progress" src="https://img.shields.io/badge/ROADMAP-94.1%25-7c3aed?style=for-the-badge">
  <img alt="Completed" src="https://img.shields.io/badge/DONE-64%2F68-1f6feb?style=for-the-badge">
  <img alt="Status" src="https://img.shields.io/badge/STATUS-V6.1%20IN%20PROGRESS-7c3aed?style=for-the-badge">
</p>
...
## v6.1 — Battlefield Control & Multi-Stage Operations — IN PROGRESS
- [ ] Deterministic multi-stage operations chain capture, interdiction and final hold phases into one playable mission arc on selected non-boss rounds without replacing TankGame round authority.
- [ ] Sector-control simulation allows enemies to contest and reverse capture progress while designated command targets connect live combat to operation advancement.
- [ ] Operation HUD and battlefield markers clearly expose current phase, contest state, command target and War Bond reward through existing progression systems.
- [ ] Packaged Windows multi-stage-operation gate boots the exact development EXE and verifies phase catalog, scheduling, contest/reward bounds and runtime installation.
