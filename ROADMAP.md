...
<p align="center">
  ...
  <img alt="Completed" src="https://img.shields.io/badge/DONE-141%2F146-1f6feb?style=for-the-badge">
  <img alt="Status" src="https://img.shields.io/badge/STATUS-V8.0%20IN%20PROGRESS-f59e0b?style=for-the-badge">
</p>
...
## v8.0 — Public Demo 2 Release Candidate & Full Campaign Integration — IN PROGRESS
- [ ] Demo-facing integration layer introduces the advanced counterplay controls (`R` smoke, `C` ECM, `V` decoy, `G` SIGINT, `H` recon) progressively and compactly without restoring permanent tutorial clutter.
- [ ] Campaign integration verification covers the full v7.1–v7.9 system stack and representative round bands, including EW/network warfare and Mobile HQ operation thresholds.
- [ ] Dedicated non-development Demo 2 RC packaging emits an exact-commit manifest, Windows x64 ZIP and SHA-256 checksum with current v8.0 identity.
- [ ] Fresh Windows runner boots the exact packaged Demo 2 RC and verifies all required v7.x gameplay/presentation directors are installed and configuration-valid.
- [ ] The same packaged candidate passes integrated soak checkpoints 36/50/80/90/100 with blocking exception detection before v8.0 can be marked qualified.
