...
<p align="center">
  ...
  <img alt="Roadmap progress" src="https://img.shields.io/badge/ROADMAP-96.5%25-f59e0b?style=for-the-badge">
  <img alt="Completed" src="https://img.shields.io/badge/DONE-109%2F113-1f6feb?style=for-the-badge">
  <img alt="Status" src="https://img.shields.io/badge/STATUS-V7.2%20IN%20QUALIFICATION-f59e0b?style=for-the-badge">
</p>
...
## v7.2 — Enemy AI, Squad Tactics & Boss Behavior Reforge — IN QUALIFICATION
- [ ] Coordinated enemy squad layer assigns six live tactical roles (Vanguard/Flanker/Suppressor/Breaker/Escort/Hunter) across existing EnemyTank classes and executes bounded crossfire/suppression/breaker beats through authoritative TankGame projectile spawning.
- [ ] Squad pressure scales across the 100-round campaign with strict shot/cadence budgets, RuntimeBattleRegistry integration and no replacement of EnemyTank movement, Health, Projectile or collision authority.
- [ ] Boss rounds gain phase-aware command behavior that turns BossLegend phase transitions into coordinated escort volleys and changing player/Orzełek pressure instead of isolated boss-only attacks.
- [ ] Packaged Windows squad-AI gate boots the exact development EXE and verifies role catalog, shot/cadence bounds, boss-command installation, RuntimeBattleRegistry integration and version identity.
