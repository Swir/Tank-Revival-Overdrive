...
<p align="center">
  ...
  <img alt="Completed" src="https://img.shields.io/badge/DONE-100%2F105-1f6feb?style=for-the-badge">
  <img alt="Status" src="https://img.shields.io/badge/STATUS-V7.0%20IN%20DEVELOPMENT-7c3aed?style=for-the-badge">
</p>
...
## v7.0 — Public Demo 2 & Final Player Experience Reforge — IN DEVELOPMENT
- [ ] Player-facing shell is refreshed for Demo 2 with current build identity, cleaner menu/pause/end presentation and no stale pre-demo version labels.
- [ ] First-ten-round contextual coaching replaces persistent instruction clutter with short auto-hiding movement, firing, ammunition, Orzełek and tactical-HUD prompts.
- [ ] Combat HUD defaults to a battlefield-first minimal presentation while preserving player-selectable Minimal/Focus/Standard modes and all critical tactical warnings.
- [ ] Dedicated Demo 2 candidate packaging produces a non-development Windows x64 ZIP with exact-commit manifest and SHA-256 checksum.
- [ ] Fresh Windows runners boot the exact packaged Demo 2 EXE and complete smoke plus late-round 80/90/100 qualification before the candidate is considered release-ready.
