...
namespace TankRevival
{
    ...
    public sealed class CounterBatteryDirectorV140 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            AdaptiveEnemyCommandDirector.EnsureInstalled(); BattlefieldCohesionDirector.EnsureInstalled(); CounterBatteryExecutionBridgeV140.EnsureInstalled(); CounterObservationDirectorV141.EnsureInstalled(); CounterObservationDirectorV141.EnsureInstalled(); CounterObservationDirectorV141.EnsureInstalled(); CounterObservationDirectorV141.EnsureInstalled();
