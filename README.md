...
| Item | Status |
|---|---|
| Development milestone | **V14.1 QUALIFIED** on `dev-v14-1` |
| Roadmap | **479 / 479 completed (100.0%)** — authoritative `ROADMAP.md` scope |
...
### Counter-Observation & Hunter-Killer Warfare v14.1 — qualified
