...
[![Roadmap](https://img.shields.io/badge/Roadmap-99.0%25%20V14.1%20In%20Development-02050A?style=for-the-badge&logo=github&logoColor=62E5FF)](ROADMAP.md)
...
| Roadmap | **474 / 479 completed (99.0%)** — authoritative `ROADMAP.md` scope |
...
| 🔭 **Counter-observation warfare v14.1 — in development** | Source-verified observer hunts use tracked/verified sensor evidence, canonical Health kill confirmation and a bounded network-break multiplier that reduces v14.0 acquisition without deleting shells or granting immunity. |
...
The authoritative roadmap is [`ROADMAP.md`](ROADMAP.md). The current scoped state is **474 / 479 (99.0%) — V14.1 IN DEVELOPMENT**. Release readiness is tracked separately by exact-candidate Windows qualification gates.
