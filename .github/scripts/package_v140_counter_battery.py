#!/usr/bin/env python3
"""Deterministically stage/package one exact v14.0 Counter-Battery Windows candidate."""
...
ATTRIBUTION_NAME = "V140_COUNTER_BATTERY_BUILD.txt"
SHA_NAME = "V140_COUNTER_BATTERY_SHA256.txt"
PROVENANCE_NAME = "V140_COUNTER_BATTERY_PROVENANCE.json"
TREE_NAME = "V140_COUNTER_BATTERY_BUILD_TREE.txt"
DEFAULT_ZIP = "TankRevivalOverdrive-v14.0-counter-battery-Windows-x64.zip"
...
def package_candidate(
    ...
    provenance = {
        "schema": "tank-revival-v14.0-counter-battery/v1",
        "candidate_sha": candidate_sha,
...
def main(argv=None):
    ...
    try:
        ...
        print(f"v14.0 packaging FAILED: {exc}", file=sys.stderr)
        try:
