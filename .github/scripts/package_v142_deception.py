#!/usr/bin/env python3
"""Deterministically stage/package one exact v14.2 deception/EMCON Windows candidate."""
...
ATTRIBUTION_NAME = "V142_DECEPTION_BUILD.txt"
SHA_NAME = "V142_DECEPTION_SHA256.txt"
PROVENANCE_NAME = "V142_DECEPTION_PROVENANCE.json"
TREE_NAME = "V142_DECEPTION_BUILD_TREE.txt"
DEFAULT_ZIP = "TankRevivalOverdrive-v14.2-deception-Windows-x64.zip"
...
def package_candidate(
    ...
    provenance = {
        "schema": "tank-revival-v14.2-deception/v1",
        "candidate_sha": candidate_sha,
...
def main(argv=None):
    ...
    try:
        ...
        print(f"v14.2 packaging FAILED: {exc}", file=sys.stderr)
        try:
