#!/usr/bin/env python3
"""Deterministically stage/package one exact v13.9 Fire-Support Windows candidate."""
...
ATTRIBUTION_NAME = "V139_FIRE_SUPPORT_BUILD.txt"
SHA_NAME = "V139_FIRE_SUPPORT_SHA256.txt"
PROVENANCE_NAME = "V139_FIRE_SUPPORT_PROVENANCE.json"
TREE_NAME = "V139_FIRE_SUPPORT_BUILD_TREE.txt"
DEFAULT_ZIP = "TankRevivalOverdrive-v13.9-fire-support-Windows-x64.zip"
...
def package_candidate(
    ...
    provenance = {
        "schema": "tank-revival-v13.9-fire-support/v1",
        "candidate_sha": candidate_sha,
...
def main(argv=None):
    ...
    try:
        ...
        print(f"v13.9 packaging FAILED: {exc}", file=sys.stderr)
        try:
