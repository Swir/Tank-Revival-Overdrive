#!/usr/bin/env python3
"""Deterministically stage/package one exact v14.3 smoke/break-contact Windows candidate."""
...
ATTRIBUTION_NAME = "V143_SMOKE_BUILD.txt"
SHA_NAME = "V143_SMOKE_SHA256.txt"
PROVENANCE_NAME = "V143_SMOKE_PROVENANCE.json"
TREE_NAME = "V143_SMOKE_BUILD_TREE.txt"
DEFAULT_ZIP = "TankRevivalOverdrive-v14.3-smoke-Windows-x64.zip"
...
def package_candidate(
    ...
    provenance = {
        "schema": "tank-revival-v14.3-smoke/v1",
        "candidate_sha": candidate_sha,
...
def main(argv=None):
    ...
    try:
        ...
        print(f"v14.3 packaging FAILED: {exc}", file=sys.stderr)
        try:
